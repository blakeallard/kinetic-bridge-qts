...
def main():
    ...
    w('| `300300`, `300500` | Unit-price rows vs bundle-style rows (see '
      '`docs/LIBAL_REFERENCE_PRICE_QC.md` and `import_preview/duplicate_sku_classification.json`) | Prefer visible unit-price row as canonical; hidden bundle row as excluded |')
