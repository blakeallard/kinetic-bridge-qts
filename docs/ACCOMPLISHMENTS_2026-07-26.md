...
| 12 | Datasheet spec DB kicked off | Supabase (`kinetic-quote`) | Background agent building sourced spec tables from real AcmeBMS PDFs + scraper/parser scripts + LEARNING.md tutorial (in flight) |
