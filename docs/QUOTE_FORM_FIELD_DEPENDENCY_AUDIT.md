...
5. **DKK FX (updated 2026-07-30):** `fn_refresh_fx_rates.deluge` **does** cache DKK. Remaining ops item is scheduling that function daily (see [`QTS_BRYAN_MEETING_BACKLOG_2026-07-30.md`](./QTS_BRYAN_MEETING_BACKLOG_2026-07-30.md) Stage 9), not adding DKK to the refresh list.
