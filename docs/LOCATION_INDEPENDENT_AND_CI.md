...
| ------ | ------------------- |
| `import_preview/generate_preview.py` | CLI arg → `LIBAL_RSP_XLSX` → optional in-repo `fixtures/` or `data/references/…` |
...
```bash
export LIBAL_RSP_XLSX="/path/to/Lithium Balance BMS_July 01_RSP_Distributor.xlsx"
