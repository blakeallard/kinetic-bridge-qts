...
- BMS kit auto-population + component quantity rules (CMU count from series cell count, warn-don't-block quoting) — new workstream from the 2026-07-07 meeting, requirements and datasheet reconciliation in `docs/MEETING_REQUIREMENTS_2026-07-07.md`; kit BOM mapping/validation deferred to the next pass
