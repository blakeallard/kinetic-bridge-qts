...
### 4. Bevco's Distributor Tier with Lithium Balance

**Decision needed:** Is Bevco currently at the **Partner** tier (>750k EUR) or the **Distributor** tier (250k–750k EUR) with Lithium Balance?
...
**Data needed:** Where does Bevco track the unit cost (DKK or USD) for each Lithium Balance item?
...
- Build `Items` form and import Lithium Balance price list
...
- The Lithium Balance distributor tier table (from the price list)
